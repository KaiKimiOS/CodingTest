...
// MARK: - 누적 합으로 구하기
// N, M 이 모두 <= 100,000 이내이기 때문에 N^2 이내의 시간복잡도가 필요하다
...
// MARK: - 예제 5,3 -> 5는 나올 수의 갯수 -> 5개의 숫자가 나온다. 3은 몇 번 합을 실행해야하는지
...
// MARK: - 5,4,3,2,1 을 누적합을 해준다 -> answer에는 [0,5,9,12,14,15]이 담긴다
